...
public class AuditPersistenceServiceFactory {
    ...
    private static AuditPersistenceService createInstance() {
        ...
        // Inject mapper manually via reflection or setter if available
        // service.setSysAuditLogMapper(sqlSessionFactory.openSession().getMapper(SysAuditLogMapper.class));
